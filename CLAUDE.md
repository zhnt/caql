...
## 项目概述
AQL (AI Query Language) 是一个面向AI时代的原生编程语言，以 Lua 5.5.1 的 VM/运行时语义作为核心基线，并保留 AQL 容器系统与未来 AI 工作流语法作为显式扩展。
...
### 代码审查要点
- 确保 Lua 5.5.1 核心语义不被 AQL 扩展悄悄改变
- 检查内存管理正确性
- 验证SIMD优化适用性
- 测试嵌入API稳定性
